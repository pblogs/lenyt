class Mailboxer::Conversation < ActiveRecord::Base
  ...
  scope :inbox, lambda {|participant|
    participant(participant).merge(
      Mailboxer::Receipt.inbox.not_trash.not_deleted
    )
  }
  scope :sentbox, lambda {|participant|
    participant(participant).merge(
      Mailboxer::Receipt.sentbox.not_trash.not_deleted
    )
  }
  ...
  # Returns true if the participant has at least one trashed message
  # of the conversation
  ...
  # Returns true if the participant has trashed all the messages
  # of the conversation
  ...
  # Returns true if the participant has at least one unread message
  # of the conversation
